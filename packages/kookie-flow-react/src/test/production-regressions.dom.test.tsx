...
import type { Entity, Edge } from '@kushagradhawan/kookie-flow-core/types';
import {
  buildGlyphMap,
  buildKerningMap,
  measureText,
...
import { EMBEDDED_FONT_METRICS_REGULAR } from '@kushagradhawan/kookie-flow-webgl/internal/core/embedded-font';
...
it('opaque socket IDs survive evaluation, defaults and pending-value serialization', async () => {
  ...
  s.getState().setEvaluationHandlers((_id, _type, resolved) => {
    inputs = resolved;
    return {};
  });
