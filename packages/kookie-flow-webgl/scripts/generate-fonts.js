 ...
 *   pnpm generate:fonts inter --embed-only - Re-embed the checked-in atlases without rebuilding them
 */
...
async function embedFonts(familyKey, familyConfig, fonts) {
  ...
  // Metrics belong to core; every generated renderer family shares that contract.
  const importPath = '@kushagradhawan/kookie-flow-core/internal/utils/text-layout';
