...
import type { AccentColor } from '../../../kookie-flow-core/src/types/index.ts';
 ...
 */
const RAW = import.meta.glob('../../../kookie-flow-core/src/types/index.ts', {
  query: '?raw',
  import: 'default',
  eager: true,
...
function unionMembers(): AccentColor[] {
  const src = RAW['../../../kookie-flow-core/src/types/index.ts'];
