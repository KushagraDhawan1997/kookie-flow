...
export function buildRuntimeAtlas(options: RuntimeAtlasOptions = {}): RuntimeAtlas | null {
  ...
  const ascent =
    reference.fontBoundingBoxAscent || reference.actualBoundingBoxAscent || ATLAS_FONT_SIZE * 0.8;
  const descent =
    reference.fontBoundingBoxDescent || reference.actualBoundingBoxDescent || ATLAS_FONT_SIZE * 0.2;
