...
export { isSocketCompatible } from '@kushagradhawan/kookie-flow-core/internal/utils/connections';
...
export { resolveWidgetConfig, isSocketConnected, buildConnectedSocketsSet } from './widgets';

// Per-entity accent color utilities
export { NO_OVERRIDE_SENTINEL, resolveAccentColorRGB } from './accent-colors';
