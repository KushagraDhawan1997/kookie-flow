import type { TextEntityData, TextSizingMode } from '../types/index';
import {
  DEFAULT_TEXT_FONT_SIZE,
  DEFAULT_TEXT_LINE_HEIGHT,
  DEFAULT_TEXT_PADDING,
} from '../core/constants';
import { type GlyphMap, type KerningMap, measureTextBlockMSDF } from './text-layout';
...
export function resolveTextStyle(
  ...
  return {
    fontFamily:
      data.fontFamily ?? defaults?.fontFamily ?? '"Inter", system-ui, -apple-system, sans-serif',
