...
const widgetDemoNodes: Node[] = [
  ...
  // Extremely complex nodes with many widgets
  {
    ...
    inputs: [
      { id: 'cx1-in-0', name: 'Prompt', type: 'string', placeholder: 'Enter prompt...' },
      { id: 'cx1-in-1', name: 'Negative', type: 'string', placeholder: 'Negative prompt...' },
      { id: 'cx1-in-2', name: 'Width', type: 'int', min: 64, max: 2048 },
      { id: 'cx1-in-3', name: 'Height', type: 'int', min: 64, max: 2048 },
      { id: 'cx1-in-4', name: 'Steps', type: 'int', min: 1, max: 150 },
      { id: 'cx1-in-5', name: 'CFG Scale', type: 'float', min: 1, max: 30 },
      { id: 'cx1-in-6', name: 'Seed', type: 'int' },
      {
        id: 'cx1-in-7',
        name: 'Sampler',
        type: 'enum',
      ...
      { id: 'cx1-in-9', name: 'Denoise', type: 'float', min: 0, max: 1 },
      { id: 'cx1-in-10', name: 'Batch Size', type: 'int', min: 1, max: 16 },
      { id: 'cx1-in-11', name: 'Tiling', type: 'boolean' },
      { id: 'cx1-in-12', name: 'Hi-Res Fix', type: 'boolean' },
      { id: 'cx1-in-13', name: 'Clip Skip', type: 'int', min: 1, max: 12 },
    ],
    outputs: [
      { id: 'cx1-out-0', name: 'Image', type: 'image' },
      { id: 'cx1-out-1', name: 'Latent', type: 'signal' },
      { id: 'cx1-out-2', name: 'Seed Used', type: 'int' },
    ],
  },
  {
    id: 'complex-node-2',
